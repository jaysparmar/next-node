...
const insertRole = async data => {
  ...
  await knex('admin_roles_permissions').insert(rolePermissions)
...
const updateRole = async (role_id, data) => {
  ...
  await knex('admin_roles_permissions').where({ role_id }).del()
  await knex('admin_roles_permissions').insert(rolePermissions)
...
const deleteRole = async id => {
  await knex('admin_roles_permissions').where({ role_id: id }).del()
